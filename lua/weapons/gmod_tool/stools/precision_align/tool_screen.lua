...
local ToolType_Current = 1 --GetConVar("precision_align_tooltype"):GetInt()
local ToolTypeLookup = {
	{"Point", "Hitpos"},
	{"Point", "Coordinate Centre"},
	{"Point", "Mass Centre"},
	{"Point", "Bounding Box Centre"},
	{"Line", "Start / End (Alt)"},
	{"Line", "Hitpos + Hitnormal"},
	{"Line", "Hitnormal"},
	{"Plane", "Hitpos + Hitnormal"},
	{"Plane", "Hitnormal"}
}
...
function PA_DrawToolScreen( w, h )
	local r, e = pcall( function()
		...
		ToolType_Current = GetConVar("precision_align_tooltype"):GetInt()
